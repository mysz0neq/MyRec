# Classic Matrix Factorization with a slightly modified SGD recommendation engine.
...
The first lines of code in my life were written for this project, so it has been evolving with me for the last year, and this repository is a cleaned-up version of the project. Please keep in mind that I started learning programming in February 2025 and I'm still learning, so some things in the project may not be perfect.
...
* **LLM integration in the distant future:** With a working and stable recommendation engine in the planned web app, I plan to implement another custom-made ML project - this time a BERT-like LLM for user review analysis.
